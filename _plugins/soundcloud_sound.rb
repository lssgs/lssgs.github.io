...
#  Usage:
#
#    {% soundcloud_sound 734526450 %}
#    {% soundcloud_sound 734526450 html5 %}
#    {% soundcloud_sound 734526450 html5 903440 %}
#    {% soundcloud_sound 814082860 html5 903440 small %}
#
...
#  <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/814082860&color=%23903440&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
